[![Maintained by Staropshq.com](https://img.shields.io/badge/maintained%20by-staropshq.com-%235849a6.svg)](https://staropshq.com/?ref=repo_google_gke)
[![GitHub tag (latest SemVer)](https://img.shields.io/github/tag/staropshq/terraform-gcp-gke.svg?label=latest)](https://github.com/staropshq/terraform-gcp-gke/releases/latest)
...
repo. Check out the [gke-basic-helm example documentation](https://github.com/staropshq/terraform-gcp-gke/blob/master/examples/gke-basic-helm)
for instructions.
...
- [root](https://github.com/staropshq/terraform-gcp-gke/tree/master): The root folder contains an example of how
  to deploy a GKE Public Cluster with an example chart with [Helm](https://helm.sh/). See [gke-basic-helm](https://github.com/staropshq/terraform-gcp-gke/blob/master/examples/gke-basic-helm)
  for the documentation.

- [modules](https://github.com/staropshq/terraform-gcp-gke/tree/master/modules): This folder contains the
  main implementation code for this Module, broken down into multiple standalone submodules.

  The primary module is:

  - [gke-cluster](https://github.com/staropshq/terraform-gcp-gke/tree/master/modules/gke-cluster): The GKE Cluster module is used to
  ...
  - [gke-service-account](https://github.com/staropshq/terraform-gcp-gke/tree/master/modules/gke-service-account):
    Used to configure a GCP service account for use with a GKE cluster.

- [examples](https://github.com/staropshq/terraform-gcp-gke/tree/master/examples): This folder contains
  examples of how to use the submodules.

- [test](https://github.com/staropshq/terraform-gcp-gke/tree/master/test): Automated tests for the submodules
  and examples.
...
This Module and its Submodules are maintained by [StarOps](http://www.staropshq.com/). If you are looking for help or
commercial support, send an email to
[hello@staropshq.com](mailto:hello@staropshq.com?Subject=GKE%20Module).

It was originally maintained by Gruntwork, but was not being actively mainetained.

StarOps can help with:
...
Contributions are very welcome! Check out the [Contribution Guidelines](https://github.com/staropshq/terraform-gcp-gke/blob/master/CONTRIBUTING.md)
for instructions.

## How is this Module versioned?

This Module follows the principles of [Semantic Versioning](http://semver.org/). You can find each new release, along
with the changelog, in the [Releases Page](https://github.com/staropshq/terraform-gcp-gke/releases).
...
Please see [LICENSE](https://github.com/staropshq/terraform-gcp-gke/blob/master/LICENSE) for how the code in this
repo is licensed.

Copyright &copy; 2021 StarOps, Inc.

### Originally Forked from GruntWork Inc's GKE Module. But that has no longer been maintained, so it has been continued here by us.
